...
// Instantiation of Axi Bus Interface S00_AXI
	SIMON_mixed_IP_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) SIMON_mixed_IP_v1_0_S00_AXI_inst (
    ...
    SIMON_mixed_cipher_core_ctrl i_SIMON_mixed_cipher_core_ctrl (
    ...
    SIMON_mixed_cipher_core i_SIMON_mixed_cipher_core (
        .clk              (s00_axi_aclk),
        .rst              (s00_axi_aresetn),       
        .load             (core_load),        
